...
UI.Name = "YUSAKIHUB"  
UI.Parent = Players.LocalPlayer:WaitForChild("PlayerGui")  -- Use PlayerGui para visualização imediata
...
Frame.BackgroundTransparency = 0.5  -- Mudar para 0.5 para facilitar a visualização
Frame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)  -- Cor de fundo para facilitar a visualização
Frame.Parent = UI  
...
local WalkspeedSlider = Instance.new("TextBox")  -- Mudei de Slider para TextBox
...
WalkspeedSlider.Text = "10"  -- Valor padrão
...
FlyButton.MouseButton1Click:Connect(function()  
   -- Fly script goes aqui  
end)  
  
MobileButton.MouseButton1Click:Connect(function()  
   -- Mobile script goes aqui  
end)  
  
WalkspeedModifyButton.MouseButton1Click:Connect(function()  
   local walkspeedValue = tonumber(WalkspeedSlider.Text) or 10
   local player = Players.LocalPlayer
   player.Character.Humanoid.WalkSpeed = walkspeedValue  -- Modifica a velocidade de caminhada
end)  
  
BringPlayersButton.MouseButton1Click:Connect(function()  
   -- Bring players script goes aqui  
end)  
